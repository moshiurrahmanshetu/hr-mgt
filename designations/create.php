<?php
/**
 * Create Designation Form (Organization Module)
...
// Fetch active departments for the department selector
...
<div class="main-content">
    <div class="content-body" data-aos="fade-up">
        ...
        <div class="mb-4">
            ...
            <h2 class="fw-bold tracking-tight mb-1" style="color: var(--text-primary);">Create New Designation</h2>
            <p class="text-muted small mb-0">Register a corporate job designation title, establish department pairing, and define salary grade scope.</p>
        </div>
        ...
        <form action="<?php echo base_url('index.php?route=designations-store'); ?>" method="POST" class="needs-validation" novalidate>
            <?php echo csrf_field(); ?>
                    ...
                    <div class="custom-card mb-4" style="background-color: var(--bg-secondary); border-color: var(--border-color);">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="e.g. Senior Software Engineer, Accountant" style="background-color: var(--bg-primary); border-color: var(--border-color); color: var(--text-primary);" required>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="salary_grade" class="form-control" placeholder="e.g. Grade A, Level 4, Band-IV" style="background-color: var(--bg-primary); border-color: var(--border-color); color: var(--text-primary);">
                            </div>

                            <div class="col-12">
                                <label class="form-label text-muted small fw-semibold">Job Description</label>
                                <textarea name="description" rows="3" class="form-control" placeholder="Summarize primary responsibilities, standard qualifications, or duties..." style="background-color: var(--bg-primary); border-color: var(--border-color); color: var(--text-primary);"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="custom-card mb-4" style="background-color: var(--bg-secondary); border-color: var(--border-color);">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-sm py-2 fw-semibold">
                                <i class="bi bi-save me-1"></i> Register Designation
                            </button>
